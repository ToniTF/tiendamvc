<?php
// filepath: /c:/xampp/htdocs/tiendamvc/app/views/provider/edit.php
?>
<!DOCTYPE html>
<html lang="es">
    ...
    <div class="container">
        <nav class="navbar bg-body-tertiary">
            <div class="container-fluid">
                ...
                <div class="d-flex">
                    <a href="<?= base_url() ?>provider/show/<?= $provider->provider_id ?>" class="btn btn-primary me-2">Ver Proveedor</a>
        ...
        <form action="<?= base_url() ?>provider/updateProvider/<?= $provider->provider_id ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="web" name="web" value="<?= $provider->web ?>" required>
            </div>

            <!-- Direcciones -->
            <h3>Direcciones</h3>
            <div class="addresses-container">
                <?php foreach ($provider->addresses as $clave=>$address): ?>
            ...
            <div class="phones-container">
                <?php foreach ($provider->phones as $clave=>$phone): ?>
